...
exports.checkDepartmentAdminAccess = exports.checkFacultyStudentAccess = exports.checkRolePermission = void 0;
 ...
 */
const checkRolePermission = async (userId, requiredRole) => {
    try {
 ...
 */
const checkFacultyStudentAccess = async (facultyId, studentUsn) => {
    try {
        // Get faculty details
        const faculty = await index_1.prisma.faculty.findFirst({
        ...
        if (faculty.departmentId === student.departmentId) {
            ...
            return facultySubjects.some(mapping => mapping.subject.semester === student.semester &&
...
exports.checkFacultyStudentAccess = checkFacultyStudentAccess;
/**
 ...
 */
const checkDepartmentAdminAccess = async (adminId, studentUsn) => {
    try {
        // Get admin details
        const admin = await index_1.prisma.user.findUnique({
            where: { id: adminId },
...
exports.checkDepartmentAdminAccess = checkDepartmentAdminAccess;
