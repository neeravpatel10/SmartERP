...
router.put('/profile', auth_1.authenticate, (0, validation_1.validate)(validation_1.updateUserSchema), (0, auditMiddleware_1.captureEntityState)('user', function (req) { return req.user.userId.toString(); }, function (id) { return __awaiter(void 0, void 0, void 0, function () {
...
}); }), (0, auditMiddleware_1.setAuditContext)('update', 'user', function (req) { return req.user.userId.toString(); }), user_controller_1.updateUser, auditMiddleware_1.logAudit);
