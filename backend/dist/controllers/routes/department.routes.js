...
router.put('/:id', auth_1.authenticate, auth_1.isSuperAdmin, (0, validation_1.validate)(validation_1.updateDepartmentSchema), (0, auditMiddleware_1.captureEntityState)('department', function (req) { return req.params.id; }, function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, index_1.prisma.department.findUnique({
                    where: { id: parseInt(id) }
                })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); }), (0, auditMiddleware_1.setAuditContext)('update', 'department', function (req) { return req.params.id; }), department_controller_1.updateDepartment, auditMiddleware_1.logAudit);
// Delete department - audit this action (super admin only)
router.delete('/:id', auth_1.authenticate, auth_1.isSuperAdmin, (0, auditMiddleware_1.captureEntityState)('department', function (req) { return req.params.id; }, function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, index_1.prisma.department.findUnique({
                    where: { id: parseInt(id) }
...
}); }), (0, auditMiddleware_1.setAuditContext)('delete', 'department', function (req) { return req.params.id; }), department_controller_1.deleteDepartment, auditMiddleware_1.logAudit);
