...
var faculty_controller_1 = require("../controllers/faculty.controller");
...
router.put('/:id', auth_1.authenticate, (0, validation_1.validate)(validation_2.updateFacultySchema), (0, auditMiddleware_1.captureEntityState)('faculty', function (req) { return req.params.id; }, function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, index_1.prisma.faculty.findUnique({
...
}); }), (0, auditMiddleware_1.setAuditContext)('update', 'faculty', function (req) { return req.params.id; }), faculty_controller_1.updateFaculty, auditMiddleware_1.logAudit);
