 ...
 */
export const calculateSubjectResults = async (req: Request, res: Response) => {
  try {
    ...
    for (const student of students) {
      const result = await calculateStudentSubjectResult(student.usn, subjectId);
      if (result) {
        results.push(result);
      }
    }
 ...
 */
export const calculateStudentSubjectResult = async (usn: string, subjectId: number) => {
  try {
 ...
 * Calculate results for a specific student in a subject
 */
export const calculateStudentResult = async (req: Request, res: Response) => {
  try {
    ...
    const result = await calculateStudentSubjectResult(usn, subjectId);
 ...
 */
const calculateAttendancePercentage = async (usn: string, subjectId: number): Promise<number> => {
  try {
 ...
 */
export const viewSubjectResults = async (req: Request, res: Response) => {
  try {
    const { subject_id } = req.params;
    const subjectId = parseInt(subject_id);
 ...
 */
const getAllSubjectResults = async (subjectId: number) => {
  try {
 ...
 */
export const viewStudentResults = async (req: Request, res: Response) => {
  try {
    ...
    for (const subject of subjects) {
      const result = await calculateStudentSubjectResult(usn, subject.id);
      if (result) {
        results.push({
          subject: {
            id: subject.id,
